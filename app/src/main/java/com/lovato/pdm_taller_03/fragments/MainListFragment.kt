...
import com.lovato.pdm_taller_03.adapters.CoinAdapter
import com.lovato.pdm_taller_03.adapters.CoinSimpleListAdapter
...
class MainListFragment: Fragment(){
    ...
    fun updateCoinsAdapter(coinList: ArrayList<Coin>){ coinsAdapter.changeDataSet(coinList) }
